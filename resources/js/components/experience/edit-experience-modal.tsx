...
export interface EditExperienceForm {
  company_name: string;
  job_title?: string;
  start_date?: string;
  end_date?: string;
...
export function EditExperienceModal({ show, user, experience }: { show: boolean, user: any, experience: any }) {
  ...
  const { data, setData, post, processing, errors, reset } = useForm<Required<EditExperienceForm>>({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('profile.me.experience.update', {
      id: experience.id, // assuming experience has an id field
      ...
      <DialogContent className="overflow-y-auto max-h-[90vh]">
        <form onSubmit={handleSubmit} method="POST">
          <DialogHeader>
            ...
            <DialogDescription>Ubah pengalaman anda.</DialogDescription>
          </DialogHeader>
