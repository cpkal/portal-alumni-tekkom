...
@section('content')
        ...
        <div class="row justify-content-center">
            @foreach ($alumnis as $alumni)
                <div class="col-md-4 mb-4">
                    <div class="alumni-card" onclick="showAlumniModal(this)" data-fullname="{{ $alumni->fullname }}"
                        data-nim="{{ $alumni->nim }}"
                        data-year="{{ $alumni->graduation_year }}"  style="cursor: pointer;">
                        ...
                        <h5 class="fw-bold mb-2 text-muted">{{ $alumni->fullname }}</h5>
                        <p class="text-muted">{{ $alumni->graduation_year }}</p>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    <div class="modal fade" id="alumniDetailModal" tabindex="-1" aria-labelledby="alumniDetailModalLabel"
        aria-hidden="true">
